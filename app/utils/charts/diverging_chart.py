...
def create_diverging_bar_chart(chart_data):
    ...
    fig.update_layout(
        title={
            "text": '<b>⚖️ Income vs Expense Distribution</b><br><sub style="font-size:5px; color:#7f8c8d; font-weight:normal;">Click any bar to highlight category • Click again to deselect</sub>',
            "x": 0.5,
            "xanchor": "center",
